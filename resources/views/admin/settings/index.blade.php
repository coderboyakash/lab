                        ...
                        <form action="{{route('admin.settings.reports_submit')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                  ...
                                  <div class="col-lg-3">
                                    <label for="font-family">{{__('Font type')}}</label>
                                    <select class="form-control" name="font-family" id="font-family" required>
                                        <option value="" disabled selected>{{__('Select font type')}}</option>
                                        <option value="sans-serif" @if($reports_settings['font-family']=='sans-serif') selected @endif>sans-serif</option>
                                        <option value="DejaVu Sans" @if($reports_settings['font-family']=='DejaVu Sans') selected @endif>DejaVu Sans</option>
                                        <option value="serif" @if($reports_settings['font-family']=='serif') selected @endif>serif</option>
                                        <option value="courier" @if($reports_settings['font-family']=='courier') selected @endif>courier</option>
                                        <option value="cairo" @if($reports_settings['font-family']=='cairo') selected @endif>cairo</option>
                                        <option value="cairo-black" @if($reports_settings['font-family']=='cairo-black') selected @endif>cairo-black</option>
                                        <option value="cairo-bold" @if($reports_settings['font-family']=='cairo-bold') selected @endif>cairo-bold</option>
                                        <option value="cairo-extra-light" @if($reports_settings['font-family']=='cairo-extra-light') selected @endif>cairo-extra-light</option>
                                        <option value="cairo-light" @if($reports_settings['font-family']=='cairo-light') selected @endif>cairo-light</option>
                                        <option value="cairo-semi-bold" @if($reports_settings['font-family']=='cairo-semi-bold') selected @endif>cairo-semi-bold</option>
                                        <option value="ranchers" @if($reports_settings['font-family']=='ranchers') selected @endif>ranchers</option>
                                        <option value="open-sans" @if($reports_settings['font-family']=='open-sans') selected @endif>open-sans</option>
                                        <option value="open-sans-bold" @if($reports_settings['font-family']=='open-sans-bold') selected @endif>open-sans-bold</option>
                                        <option value="open-sans-bold-italic" @if($reports_settings['font-family']=='open-sans-bold-italic') selected @endif>open-sans-bold-italic</option>
                                        <option value="open-sans-extra-bold" @if($reports_settings['font-family']=='open-sans-extra-bold') selected @endif>open-sans-extra-bold</option>
                                        <option value="open-sans-semi-bold" @if($reports_settings['font-family']=='open-sans-semi-bold') selected @endif>open-sans-semi-bold</option>
                                        <option value="open-sans-light" @if($reports_settings['font-family']=='open-sans-light') selected @endif>open-sans-light</option>
                                        <option value="redressed" @if($reports_settings['font-family']=='redressed') selected @endif>redressed</option>
                                        <option value="lato-black" @if($reports_settings['font-family']=='lato-black') selected @endif>lato-black</option>
                                        <option value="lato-bold" @if($reports_settings['font-family']=='lato-bold') selected @endif>lato-bold</option>
                                        <option value="lato" @if($reports_settings['font-family']=='lato') selected @endif>lato</option>
                                        <option value="lato-thin" @if($reports_settings['font-family']=='lato-thin') selected @endif>lato-thin</option>
                                        <option value="amiri" @if($reports_settings['font-family']=='amiri') selected @endif>amiri</option>
                                        <option value="amiri-bold" @if($reports_settings['font-family']=='amiri-bold') selected @endif>amiri-bold</option>
                                        <option value="amiri-bold-italic" @if($reports_settings['font-family']=='amiri-bold-italic') selected @endif>amiri-bold-italic</option>
                                        <option value="amiri-italic" @if($reports_settings['font-family']=='amiri-italic') selected @endif>amiri-italic</option>
                                    </select>
                                  </div>

                                  <div class="col-lg-3">
                                    <label for="font-size">{{__('Font size')}}</label>
                                    <input type="number" class="form-control" name="font-size" id="font-size" min="1" value="{{$reports_settings['font-size']}}" required>
                                  </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3">
                                        <div class="form-group">
                                          ...
                                          <textarea name="footer" id="report_footer" cols="30" rows="10" class="form-control">{{$reports_settings['footer']}}</textarea>
                                        </div>
                                    </div>
                                </div>
